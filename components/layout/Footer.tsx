      ...
      <div className="container-app grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-4">
        <div>
          <div className="flex items-center gap-3">
            <Image src="/logo.svg" alt="Logo GEMARI" width={34} height={34} />
            <div>
              <p className="text-sm font-bold text-white">GEMARI</p>
              <p className="text-xs">Gerakan Muda Mudi Blimbingsari</p>
            </div>
          </div>
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2.5 text-sm">
            <li>
              <Link href="/profil/tentang" className="hover:text-white">
                Tentang Organisasi
              </Link>
            </li>
            <li>
              <Link href="/profil/sejarah" className="hover:text-white">
                Sejarah
              </Link>
            </li>
            <li>
              <Link href="/profil/struktur" className="hover:text-white">
                Struktur Organisasi
              </Link>
            </li>
          </ul>
